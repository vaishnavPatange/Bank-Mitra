  ...
  try {
    ...
    // Response With Error Message [No Data].
      ...
      switch (errorCode) {
        // If Input Is Empty
        case 1:
          alerts("Please enter department name!");
          break;
        // If URL Is Not Valid
        case 2:
          alerts("Invalid department name, Please enter a valid department name.");
          break;
...
shortUrlForm.addEventListener("submit", (e) => {
  ...
  // Change Submit Button Text
  submitButton.innerHTML = `<i class="fa-solid fa-spinner icon fa-spin"></i> Searching...`;
